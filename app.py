...
def main():
    ...
    # Integration of Gemini AI assistant
    st.write("Integration with SkillMatchPro Assistant:")
    st.write("Welcome to this CareerPathFinder Dashboard. You can proceed by providing your Google API Key")
    ...
    st.title("SkillMatchPro Assistant")
